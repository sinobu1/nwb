...
# API ключи
_API_KEYS_PROVIDER = {
    "CUSTOM_GEMINI_2_5_PRO_API_KEY": os.getenv("CUSTOM_GEMINI_2_5_PRO_API_KEY", "YOUR_GEMINI_API_KEY"),
    "CUSTOM_GROK_3_API_KEY": os.getenv("CUSTOM_GROK_3_API_KEY", "YOUR_GROK_3_API_KEY"),
