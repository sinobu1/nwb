...
# --- Обновленные РЕЖИМЫ РАБОТЫ с фокусом на простой структурированный текст ---
AI_MODES = {
    "universal_ai": {
        ...
        "welcome": "Активирован режим 'Универсальный ИИ'. Какой у вас запрос?" # Это сообщение для пользователя, может содержать Markdown
    },
    "creative_helper": {
        ...
        "welcome": "Режим 'Творческий Помощник' к вашим услугам! Над какой творческой задачей поработаем?" # Это сообщение для пользователя
    },
}
